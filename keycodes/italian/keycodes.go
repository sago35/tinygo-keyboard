...
const (
	...
	KeyDash        = keycodes.TypeNormal | 0x38
...
var CharToKeyCodeMap = [256]keyboard.Keycode{
	...
	KeyAGrave | keycodes.ShiftMask,      //  42   °
	KeyOGrave | keycodes.ShiftMask,      //  43   ç
	KeyComma,                            //  44   ,
	KeySingleQuote,                      //  45   '
	KeyPeriod,                           //  46   .
	KeyDash,                             //  47   -
	...
	KeySingleQuote | keycodes.ShiftMask, //  61   ?
	KeyPeriod | keycodes.ShiftMask,      //  62   :
	KeyDash | keycodes.ShiftMask,        //  63   _
	KeyEGrave,                           //  64   è
	...
	KeyUGrave,                           //  93   ù
	KeyIGrave,                           //  94   ì
	KeyEGrave | keycodes.ShiftMask,      //  96   é
	KeyA,                                //  97   a
	KeyB,                                //  98   b
	KeyC,                                //  99   c
	KeyD,                                // 100   d
	...
	KeyY,                                // 121   y
	KeyZ,                                // 122   z
	KeyPlus | keycodes.ShiftMask,        // 123   *
	KeyUGrave | keycodes.ShiftMask,      // 125   §
	KeyIGrave | keycodes.ShiftMask,      // 126   ^
	KeyDelete,                           // 127   DEL
}
